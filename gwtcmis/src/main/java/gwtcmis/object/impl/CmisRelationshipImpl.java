...
import gwtcmis.object.CmisRelationship;
...
public class CmisRelationshipImpl extends CmisObjectImpl implements CmisRelationship
{
   ...
   /**
    * @see gwtcmis.object.CmisRelationship#getSourceId()
    */
   ...
   /**
    * @see gwtcmis.object.CmisRelationship#getTargetId()
    */
   ...
   /**
    * @see gwtcmis.object.CmisRelationship#setSourceId(java.lang.String)
    */
   ...
   /**
    * @see gwtcmis.object.CmisRelationship#setTargetId(java.lang.String)
    */
