...
package gwtcmis.service.relationship.event;

import gwtcmis.model.EnumRelationshipDirection;
...
public class RelationshipsReceivedEvent extends GwtEvent<RelationshipsReceivedHandler>
{
   ...
   /**
    * @return {@link gwtcmis.model.restatom.EnumLinkRelation EnumLinkRelation}
    */
